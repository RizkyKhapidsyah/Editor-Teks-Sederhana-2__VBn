...
Public Class Form1
    ...
    Private Sub mnuHelpTentang_Click(sender As Object, e As EventArgs) Handles mnuHelpTentang.Click
        ...
        MessageBox.Show("Editor Teks Sederhana Versi 1.0 by Rizky Khapidsyah")
    End Sub
    ...
    Private Sub mnuFileCetak_Click(sender As Object, e As EventArgs) Handles mnuFileCetak.Click
